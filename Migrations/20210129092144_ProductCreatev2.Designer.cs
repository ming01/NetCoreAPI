...
namespace RPG_Project.Migrations
{
    ...
    [Migration("20210129092144_ProductCreatev2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPG_Project.Models.Product.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RPG_Project.Models.Product.ProductGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RPG_Project.Models.Product.ProductGroup", b =>
                {
                    b.HasOne("RPG_Project.Models.Product.Product", null)
                        .WithOne("ProductGroup")
                        .HasForeignKey("RPG_Project.Models.Product.ProductGroup", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
