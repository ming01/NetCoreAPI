...
namespace RPG_Project.Services.Character
{
    public class CharacterService : ICharacterService
    {
        ...
        {
            var characters = await _dBContext.Characters.Include(x => x.Weapon).Include(x => x.CharacterSkill).ThenInclude(x => x.Skill).AsNoTracking().ToListAsync();
        ...
        {
            var character = await _dBContext.Characters.Include(x => x.Weapon).Include(x => x.CharacterSkill).ThenInclude(x => x.Skill).FirstOrDefaultAsync(x => x.Id == characterId);
